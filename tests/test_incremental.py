...
def test_classify_and_state_round_trip():
    ...
    rows = state_rows(result, policy_version="P1", dependency_digest_value="D1", run_id="RUN-1", as_of="2026-08-20T08:00:00+04:00")
...
def test_shadow_cache_accepts_identical_recalculation_and_detects_mismatch():
    ...
    changed = shadow_cache_rows([changed_item], {"I-1": fingerprint}, provenance, run_id="RUN-3", as_of="A3")
