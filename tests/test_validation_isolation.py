...
def test_create_transient_n_ecrit_ni_snapshot_ni_dashboard(monkeypatch):
    calls = []
    ...
    args = SimpleNamespace(as_of="2026-08-14T17:00:00+04:00", start=None, layers="all", transient=True)
