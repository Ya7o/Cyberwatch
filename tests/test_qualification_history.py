...
def test_history_rows_keeps_source_coverage_and_field_decisions():
    report={"coverage":[{"Source_ID":"SRC","Field":"Sector","Total":10,"Known":8,"Unknown":2,"Coverage_pct":80.0}],"decision_summary":[{"Origin":"A","Field":"Sector","Decisions":3,"Applied":2,"Rejected":1,"Protected":0},{"Origin":"B","Field":"Sector","Decisions":2,"Applied":1,"Rejected":0,"Protected":1}]}
...
def test_detect_source_drift_uses_own_recent_baseline():
    ...
    assert len(alerts)==1 and "coverage_drop=4.0pp" in alerts[0]["Reasons"] and "unknown_growth=40.0%" in alerts[0]["Reasons"]
